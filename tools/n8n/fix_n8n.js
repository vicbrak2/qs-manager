...
(async () => {
    try {
        ...
        if (!credMap.huggingFaceApi) {
            console.log("Creating HF Credential...");
        ...
        if (!credMap.qdrantApi) {
            console.log("Creating Qdrant Credential...");
        ...
        if (wf.code === 200 && wf.data.nodes) {
            wf.data.nodes.forEach(n => {
                ...
                if (n.name === 'Qdrant Vector Store Tool' && credMap.qdrantApi) {
            ...
            if (upd.code === 200) {
                ...
                if (act.code === 200) console.log("Activated! You can test it now.");
                else console.log("Activation Failed:", act);
            } else {
                console.log("Update failed:", upd);
            }
        }
    } catch (e) {
        console.error(e);
