        ...
        <div class="finance-main">
          ...
          <section class="finance-section" aria-labelledby="finance-result-title">
            ...
            <div class="finance-result-grid">
              ...
              <div class="finance-card finance-card--expense"><div class="finance-card-title">Profesionales y traslado</div><div class="finance-val" id="finance-val-costs">$ 0</div><p>Costos directos de servicios terminados.</p></div>
