# Graph Report - qs-manager-v2  (2026-07-26)

## Corpus Check
- 198 files · ~106,341 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1449 nodes · 1955 edges · 151 communities (67 shown, 84 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 91 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0cfac4ae`
...
1. `$()` - 46 edges
2. `PostgresSheetReplicaImporter` - 43 edges
3. `Booking` - 32 edges
4. `HttpRoutesTest` - 28 edges
5. `Bitacora` - 26 edges
6. `SheetRowMapper` - 22 edges
7. `Informe Final Consolidado — Benchmark Exhaustivo de 26 Cuentas de Instagram (Belleza y Maquillaje, Chile)` - 22 edges
8. `api()` - 20 edges
...
Cohesion: 0.05
Nodes (103): addBitacoraNote(), addTramoRow(), bitacoraPayload(), collectTramos(), copyTeamBitacora(), editBitacora(), fillBitacoraStaffSelects(), loadBitacoras() (+95 more)
...
## Knowledge Gaps
- **297 isolated node(s):** `el`, `perPage`, `filtered`, `totalPages`, `bookingViewButton` (+292 more)
...
- **Why does `ConnectionFactory` connect `Community 6` to `Community 1`, `Community 15`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `AppFactory` connect `Community 1` to `Community 6`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `Booking` connect `Community 12` to `Community 32`, `Community 65`, `Community 36`, `Community 33`?**
