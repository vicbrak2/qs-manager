# Graph Report - qs-manager-v2  (2026-07-25)

## Corpus Check
- 193 files · ~103,381 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1401 nodes · 1879 edges · 151 communities (64 shown, 87 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 85 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4ac85e09`
...
1. `PostgresSheetReplicaImporter` - 43 edges
2. `$()` - 41 edges
3. `Booking` - 32 edges
...
## Communities (151 total, 87 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (92): addBitacoraNote(), bitacoraPayload(), editBitacora(), fillBitacoraStaffSelects(), loadBitacoras(), renderBitacoras(), renderBookingLink(), renderNotes() (+84 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (6): AppFactory, BookingRoutesTest, HttpRoutesTest, MockGasStreamWrapper, HttpTestCase, MockGasStreamWrapper
...
## Knowledge Gaps
- **293 isolated node(s):** `el`, `perPage`, `filtered`, `totalPages`, `bookingViewButton` (+288 more)
...
- **Why does `Booking` connect `Community 10` to `Community 32`, `Community 76`, `Community 30`, `Community 63`?**
